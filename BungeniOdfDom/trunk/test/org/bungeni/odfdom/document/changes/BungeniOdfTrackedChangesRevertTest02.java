 ...
 * @author undesa
 */
public class BungeniOdfTrackedChangesRevertTest02 {
    private static org.apache.log4j.Logger log       =
        Logger.getLogger(BungeniOdfTrackedChangesRevertTest02.class.getName());
BungeniOdfDocumentHelper               revertTestHelper = null;
String inputFile = "testdocs/tracked-changes-revert-test-02.odt";
String outputFile = "testdocs/test-revert-output-02.odt";
String testCaseName = "Document with change spanning paragraphs (slightly more complex scenario)";
long validChecksum = 4124591860L;
    public BungeniOdfTrackedChangesRevertTest02() {
