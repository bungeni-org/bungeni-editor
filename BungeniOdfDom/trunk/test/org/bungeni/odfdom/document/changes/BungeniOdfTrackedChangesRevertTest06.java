 ...
 * @author undesa
 */
public class BungeniOdfTrackedChangesRevertTest06 {
    private static org.apache.log4j.Logger log       =
        Logger.getLogger(BungeniOdfTrackedChangesRevertTest06.class.getName());
BungeniOdfDocumentHelper               revertTestHelper = null;
String inputFile = "testdocs/tracked-changes-revert-test-06.odt";
String outputFile = "testdocs/test-revert-output-06.odt";
String testCaseName = "Document with paragraph marked up as section ";
long validChecksum = 686461467L;
    public BungeniOdfTrackedChangesRevertTest06() {
