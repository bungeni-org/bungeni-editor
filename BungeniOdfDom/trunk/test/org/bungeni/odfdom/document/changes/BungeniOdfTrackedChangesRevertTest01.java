 ...
 * @author undesa
 */
public class BungeniOdfTrackedChangesRevertTest01 {
    private static org.apache.log4j.Logger log       =
        Logger.getLogger(BungeniOdfTrackedChangesRevertTest01.class.getName());
BungeniOdfDocumentHelper               revertTestHelper = null;
String inputFile = "testdocs/tracked-changes-revert-test-01.odt";
String outputFile = "testdocs/test-revert-output-01.odt";
String testCaseName = "Document with change spanning paragraphs ";
        long validChecksum = 4124591860L ;
        
    public BungeniOdfTrackedChangesRevertTest01() {
