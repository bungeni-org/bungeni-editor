...
public class brokenReferences extends BaseLaunchablePanel {
    ...
    private static org.apache.log4j.Logger log       =
        org.apache.log4j.Logger.getLogger(brokenReferences.class.getName());
        ...
        tblBrokenReferences.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent evt) {
                if (evt.getClickCount() == 2) {
                    ...
                    if (nRow != -1) {
                        BrokenReferencesTableModel model   =
                            (BrokenReferencesTableModel) tblBrokenReferences.getModel();
                        BrokenReferenceContainer   ref     = model.getRowData(nRow);
                        String                     refName = ref.Name;

                        // move the cursor lazily
                        MoveCursorToRefRangeAgent moveAgent =
                            new MoveCursorToRefRangeAgent(ref.ReferenceField.getAnchor());
        ...
        try {
            ...
            while (fieldEnum.hasMoreElements()) {
                ...
                if (servInfo.supportsService("com.sun.star.text.TextField.GetReference")) {
                    ...
                    short        refFieldSource =
                        AnyConverter.toShort(propSet.getPropertyValue("ReferenceFieldSource"));
    ...
    private void initComponents() {
        ...
        tblBrokenReferences.setModel(new javax.swing.table.DefaultTableModel(new Object[][] {
                ...
                layout.createSequentialGroup().addContainerGap().addGroup(
                    layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(
                        layout.createSequentialGroup().addComponent(
                            btnFixBroken, javax.swing.GroupLayout.PREFERRED_SIZE, 132,
                            javax.swing.GroupLayout.PREFERRED_SIZE).addPreferredGap(
                                javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(
                                btnViewAll, javax.swing.GroupLayout.PREFERRED_SIZE, 135,
                                javax.swing.GroupLayout.PREFERRED_SIZE).addPreferredGap(
                                    javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(
                    ...
                    layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(
                        ...
                        javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)).addPreferredGap(
                            ...
                            javax.swing.GroupLayout.PREFERRED_SIZE).addGap(7, 7, 7).addGroup(
                                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(
                                    btnClose).addComponent(btnFixBroken).addComponent(btnViewAll)).addContainerGap(
                                        13, Short.MAX_VALUE)));
