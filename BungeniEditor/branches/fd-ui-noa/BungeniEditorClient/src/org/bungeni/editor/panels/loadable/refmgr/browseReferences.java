...
public class browseReferences extends BaseLaunchablePanel {
    ...
    private static org.apache.log4j.Logger log                =
        org.apache.log4j.Logger.getLogger(browseReferences.class.getName());
    ...
    private void applyInsertCrossReference() {
        ...
        if (nSelectedRow != -1) {    // nothing was selected
            ...
            ArrayList<DocumentInternalReference> referenceSourceChain = getReferenceSourceChain(ref.ReferenceType,
                                                                            selectedSection);
    ...
    private boolean insertCrossRef(ArrayList<DocumentInternalReference> referenceChain) {
        ...
        try {
            ...
            for (int i = lastIndex; i >= 0; i--) {
                ...
                ReferencesSyntax                        billRefSyntax =
                    ReferencesSyntaxFactory.getSyntaxObject("bill-format-1");
                ArrayList<ReferencesSyntax.QuerySyntax> qs            = new ArrayList<ReferencesSyntax.QuerySyntax>() {
                    {
                ...
                Object                    oRefField     =
                    ooDocument.createInstance("com.sun.star.text.TextField.GetReference");
                XPropertySet              refFieldProps = ooQueryInterface.XPropertySet(oRefField);

                refFieldProps.setPropertyValue("ReferenceFieldSource",
                                               com.sun.star.text.ReferenceFieldSource.REFERENCE_MARK);
    ...
    private void initComponents() {
        ...
        tblAllReferences.setModel(new javax.swing.table.DefaultTableModel(new Object[][] {
        ...
        cboFilterSettings.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Item 1", "Item 2", "Item 3",
                "Item 4" }));
                ...
                layout.createSequentialGroup().addContainerGap().addGroup(
                    layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(
                        layout.createSequentialGroup().addComponent(
                            btnInsertCrossRef, javax.swing.GroupLayout.PREFERRED_SIZE, 132,
                            javax.swing.GroupLayout.PREFERRED_SIZE).addPreferredGap(
                                javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(
                                btnBrowseBroken, javax.swing.GroupLayout.PREFERRED_SIZE, 135,
                                javax.swing.GroupLayout.PREFERRED_SIZE).addPreferredGap(
                                    javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(
                                    btnClose, javax.swing.GroupLayout.DEFAULT_SIZE, 116,
                                    Short.MAX_VALUE).addContainerGap()).addGroup(
                                        layout.createSequentialGroup().addComponent(
                                            lblFilterReferences, javax.swing.GroupLayout.DEFAULT_SIZE, 271,
                                                Short.MAX_VALUE).addGap(136, 136, 136)).addGroup(
                                                    layout.createSequentialGroup().addComponent(
                                                        jScrollPane1, javax.swing.GroupLayout.DEFAULT_SIZE, 395,
                                                            Short.MAX_VALUE).addContainerGap()).addGroup(
                                                                layout.createSequentialGroup().addComponent(
                                                                    txtFilterReferences,
        ...
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(
                layout.createSequentialGroup().addGap(5, 5, 5).addComponent(lblFilterReferences).addPreferredGap(
                    javax.swing.LayoutStyle.ComponentPlacement.RELATED).addGroup(
                    layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(
                        txtFilterReferences, javax.swing.GroupLayout.PREFERRED_SIZE,
                        javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE).addComponent(
                            btnRefresh).addComponent(
                            cboFilterSettings, javax.swing.GroupLayout.PREFERRED_SIZE,
                            javax.swing.GroupLayout.DEFAULT_SIZE,
                            javax.swing.GroupLayout.PREFERRED_SIZE)).addPreferredGap(
                                javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(
                                jScrollPane1, javax.swing.GroupLayout.PREFERRED_SIZE, 228,
                                javax.swing.GroupLayout.PREFERRED_SIZE).addGap(7, 7, 7).addGroup(
                                    layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(
                                        btnClose).addComponent(btnInsertCrossRef).addComponent(
                                        btnBrowseBroken)).addContainerGap(13, Short.MAX_VALUE)));
...
//      TODO add your handling code here:
            ...
            for (ooDocMetadataFieldSet metaField : referenceNames) {
                if (metaField.getMetadataName().indexOf(uuidStr) != -1) {
                    if (!documentReferences.containsKey(metaField.getMetadataName())) {
                        ...
                        String visibility       = DocumentSectionsContainer.getDocumentSectionsContainer().get(
                                                      foundSectionType).getSectionVisibilty();
                        DocumentInternalReference refObj = new DocumentInternalReference(metaField.getMetadataName(),
                                                               metaField.getMetadataValue(), secName.getName());
    ...
    class ReferencesTableModel extends AbstractTableModel {
        private String[]                     columns                    = { /* "Ref Name" , */
            "Reference To", "Reference Type", "Reference Text"
        };
