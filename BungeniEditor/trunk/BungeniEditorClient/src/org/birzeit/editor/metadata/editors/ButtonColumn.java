...
public class ButtonColumn extends AbstractCellEditor
    ...
    public ButtonColumn(JTable table, Action action, int column) {
        ...
        renderButton = new JButton(bundle.getString("CourtJudgement_Appeal.lblLinkdoc.text"));
        editButton = new JButton(bundle.getString("CourtJudgement_Appeal.lblLinkdoc.text"));
    ...
    public Component getTableCellEditorComponent(
        ...
        value = bundle.getString("CourtJudgement_Appeal.lblLinkdoc.text");
        if (value == null) {
            editButton.setText("");
