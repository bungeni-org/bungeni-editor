...
public class BungeniBNode {
    private static org.apache.log4j.Logger              log                    =
        org.apache.log4j.Logger.getLogger(BungeniBNode.class.getName());
    private static HashMap<String, INodeSetterCallback> nodeSetterCallbackList = new HashMap<String,
                                                                                     INodeSetterCallback>(0);
