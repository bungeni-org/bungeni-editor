...
public class PublicationName {
    public static final String PACKAGE_ALIAS = "publicationNames";
    public static final String CLASS_ALIAS = "publicationName";
    private Integer id;
    ...
    public PublicationName(Integer id, Name name) {
        this.id = id;
        this.name.add(name);
    }
