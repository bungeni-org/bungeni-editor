...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    -->
    <bp:template name="root" href="pipeline_xslt/bungeni/user/root.xsl"/>

    <bp:template name="preface" href="pipeline_xslt/bungeni/user/preface.xsl"/>

    <bp:template name="meta" href="pipeline_xslt/bungeni/user/meta.xsl"/>
    ...
    <bp:template name="content" href="pipeline_xslt/bungeni/user/content.xsl"/>
