...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <!-- INCLUDE FUNCTIONS -->
    <xsl:include href="resources/pipeline_xslt/test_configparams_complex/func_content_types.xsl" />
    ...
    <xsl:include href="resources/pipeline_xslt/test_configparams_complex/include_params.xsl" />
    ...
    <xsl:template match="contenttype">
        ...
        <ontology for="group">
            <!--
            <countryCode><xsl:value-of select="$country-code"></xsl:value-of></countryCode>
            <originParliament><xsl:value-of select="$origin-parliament"></xsl:value-of></originParliament>
            <currentParliament><xsl:value-of select="$current-parliament"></xsl:value-of></currentParliament>
            <parliamentID><xsl:value-of select="$current-parliament/@id"></xsl:value-of></parliamentID>
            <forParliament><xsl:value-of select="$current-parliament/forParliament"></xsl:value-of></forParliament>
            <electionDate><xsl:value-of select="$current-parliament/electionDate"></xsl:value-of></electionDate>
            -->
