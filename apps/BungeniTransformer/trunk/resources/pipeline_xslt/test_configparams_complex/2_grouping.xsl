...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:import href="resources/pipeline_xslt/test_configparams_complex/func_dates.xsl" />
    <xsl:import href="resources/pipeline_xslt/test_configparams_complex/func_content_types.xsl" />
