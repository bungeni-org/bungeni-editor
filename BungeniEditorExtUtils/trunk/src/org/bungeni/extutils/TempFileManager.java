...
public class TempFileManager {
       ...
       private static final org.apache.log4j.Logger log = Logger.getLogger(TempFileManager.class.getName());
        ...
        if (tmpFiles != null) {
            for (File tmpFile : tmpFiles) {
                ...
                if (!lockFile.exists()) {
                    ...
                    log.info("TempFileManager::deleting old temp directory " + tmpFile);
                    ...
                    try {
                        ...
                        log.info( "TempFileManager::unable to delete {0}"  + tmpFile.getAbsolutePath());
