      ...
      <mcontainer name="meta">
         <mcontainer name="identification">
            <mcontainer name="all">
               ...
               <meta name="BungeniJudgementNo"
                     value="{//meta:user-defined[@name='BungeniJudgementNo']}"/>
               ...
               <meta name="BungeniJudgementDate"
                     value="{//meta:user-defined[@name='BungeniJudgementDate']}"/>
               ...
               <meta name="BungeniJudgeName" value="{//meta:user-defined[@name='BungeniJudgeName']}"/>
               <meta name="BungeniPartyName" value="{//meta:user-defined[@name='BungeniPartyName']}"/>
