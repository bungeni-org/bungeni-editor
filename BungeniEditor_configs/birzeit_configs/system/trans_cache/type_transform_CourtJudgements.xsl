  ...
  <xsl:template match="*[@name='root']">
    <xsl:element name="akomaNtoso">
      <xsl:element name="judgement">
        ...
        <xsl:apply-templates select="//*[@name='dec-statement']" />
...
-->
  ...
  <!--
template for judgementBody
-->
  <xsl:template match="*[@name='judgementBody']">
    <xsl:element name="judgementBody">
      <xsl:if test="@id">
        <xsl:attribute name="bodf:sourceId" select="@id" />
      </xsl:if>
      <xsl:apply-templates />
  ...
  <!--
template for dec-statement
-->
  <xsl:template match="*[@name='dec-statement']">
    <xsl:element name="dec-statement">
      <xsl:if test="@id">
        <xsl:attribute name="bodf:sourceId" select="@id" />
      </xsl:if>
      <xsl:apply-templates />
...
-->
  ...
  <!--
template for add-info
-->
  <xsl:template match="*[@name='add-info']">
    <xsl:element name="add-info">
      <xsl:if test="@id">
        <xsl:attribute name="bodf:sourceId" select="@id" />
      </xsl:if>
      <xsl:apply-templates />
...
-->
  <xsl:template match="*[@name='reasoning']">
    <xsl:element name="reasoning">
      <xsl:if test="@id">
        <xsl:attribute name="bodf:sourceId" select="@id" />
      </xsl:if>
      <xsl:apply-templates />
...
-->
  <xsl:template match="*[@name='verdict']">
...
-->
  ...
  <!--
template for concl-explain-text
-->
  <xsl:template match="*[@name='concl-explain-text']">
    <xsl:element name="concl-explain-text">
      <xsl:if test="@id">
        <xsl:attribute name="bodf:sourceId" select="@id" />
      </xsl:if>
      <xsl:apply-templates />
  ...
  <!--
template for concl-explain-judges
-->
  <xsl:template match="*[@name='concl-explain-judges']">
    <xsl:element name="concl-explain-judges">
      <xsl:if test="@id">
        <xsl:attribute name="bodf:sourceId" select="@id" />
      </xsl:if>
      <xsl:apply-templates />
