      ...
      <mcontainer name="meta">
         <mcontainer name="identification">
            <mcontainer name="all">
               ...
               <meta name="BungeniOfficialDate" value="{//meta:user-defined[@name='BungeniOfficialDate']}" />
               <meta name="BungeniOfficialTime" value="{//meta:user-defined[@name='BungeniOfficialTime']}" />
...
<xsl:for-each select="key('bySectionType', 'Speech')">
      ...
      </mcontainer><mcontainer name="proprietary">
<!--Speech-->
<xsl:for-each select="key('bySectionType', 'Speech')">
            <xsl:element name="proprietary">
               <xsl:namespace name="bg" select="'http://www.proprietary.org'" />
               <xsl:element name="bg:meta" namespace="http://www.proprietary.org">
