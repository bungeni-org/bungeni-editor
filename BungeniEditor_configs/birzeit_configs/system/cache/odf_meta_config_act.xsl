      ...
      <mcontainer name="meta">
         <mcontainer name="identification">
            <mcontainer name="all">
               ...
               <meta name="BungeniEffectiveDate" value="{//meta:user-defined[@name='BungeniEffectiveDate']}" />
               ...
               <meta name="BungeniSourceSide" value="{//meta:user-defined[@name='BungeniSourceSide']}" />
               <meta name="BungeniSourceName" value="{//meta:user-defined[@name='BungeniSourceName']}" />
               ...
               <meta name="BungeniActAprovedDate" value="{//meta:user-defined[@name='BungeniActAprovedDate']}" />
    
               <meta name="BungeniActPromulgated" value="{//meta:user-defined[@name='BungeniActPromulgated']}" />
 
               <meta name="BungeniActPromulgatedDate" value="{//meta:user-defined[@name='BungeniActPromulgatedDate']}" />
    
               <meta name="BungeniActImplementation" value="{//meta:user-defined[@name='BungeniActImplementation']}" />
    
               <meta name="BungeniSecondaryActPromulgating" value="{//meta:user-defined[@name='BungeniSecondaryActPromulgating']}" />
