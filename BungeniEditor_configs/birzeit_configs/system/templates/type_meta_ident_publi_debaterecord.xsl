      ...
      <mcontainer name="meta">
         <mcontainer name="identification">
            <mcontainer name="all">
               ...
               <meta name="BungeniOfficialDate"
                     value="{//meta:user-defined[@name='BungeniOfficialDate']}"/>
               <meta name="BungeniOfficialTime"
                     value="{//meta:user-defined[@name='BungeniOfficialTime']}"/>
