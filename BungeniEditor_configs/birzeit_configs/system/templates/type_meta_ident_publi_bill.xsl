      ...
      <mcontainer name="meta">
         <mcontainer name="identification">
            <mcontainer name="all">
               ...
               <meta name="BungeniCountryCode"
                     value="{//meta:user-defined[@name='BungeniCountryCode']}"/>
               <meta name="BungeniBillNo" value="{//meta:user-defined[@name='BungeniBillNo']}"/>
               <meta name="BungeniParliamentID"
                     value="{//meta:user-defined[@name='BungeniParliamentID']}"/>
               <meta name="BungeniDateOfAssent"
                     value="{//meta:user-defined[@name='BungeniDateOfAssent']}"/>
               <meta name="BungeniDocAuthor" value="{//meta:user-defined[@name='BungeniDocAuthor']}"/>
               <meta name="BungeniBillOfficialDate"
                     value="{//meta:user-defined[@name='BungeniBillOfficialDate']}"/>
               <meta name="BungeniDateOfCommencement"
                     value="{//meta:user-defined[@name='BungeniDateOfCommencement']}"/>
               <meta name="BungeniBillOfficialTime"
                     value="{//meta:user-defined[@name='BungeniBillOfficialTime']}"/>
               ...
               <meta name="BungeniParliamentSession"
                     value="{//meta:user-defined[@name='BungeniParliamentSession']}"/>
               <meta name="BungeniParliamentSitting"
                     value="{//meta:user-defined[@name='BungeniParliamentSitting']}"/>
